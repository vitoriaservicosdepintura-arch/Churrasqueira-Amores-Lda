...
import { ArrowLeft, X, Phone, MessageCircle, Calendar, Search, SlidersHorizontal } from 'lucide-react';
                                        ...
                                        <div className="p-4 md:p-5 flex-1 flex flex-col">
                                            ...
                                            <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between gap-2">
                                                ...
                                                {item.qrCode || item.videoUrl || item.manualLink ? (
                                                    ...
                                                    >
                                                        <img
                                                            src={item.qrCode || `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(item.videoUrl || item.manualLink || '')}`}
