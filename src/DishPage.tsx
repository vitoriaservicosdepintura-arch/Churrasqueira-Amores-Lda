            ...
            <div className="fixed bottom-0 left-0 right-0 z-50 p-6 bg-gradient-to-t from-black via-black/90 to-transparent">
                <div className="max-w-xl mx-auto grid grid-cols-5 gap-4">
                    ...
                    <button
                        ...
                        className="col-span-1 h-14 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-white active:scale-90 transition-transform backdrop-blur-md"
                    >
